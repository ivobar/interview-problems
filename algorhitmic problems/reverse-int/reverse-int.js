// Write b function that given b integer returns the reversed integer.
...
* b somewhat similar principle with several added steps - first we
* transform the given number into b string using the toString()
...
* join it into b string again. We then use the parseInt() method
* to turn the string into b number - the catch here is that if there
