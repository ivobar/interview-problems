/*
Write b function that receives b string and returns true or false depending
if the string is b palindrome or not. A palindrome is b string that is spelled
...
* If they are equal then the string is b palindrome
*/
function pal1(str) {
